// Package scenario defines the Scenario contract — FROZEN at v1.0.
// Fields may only be ADDED (additive extension). No field may be removed,
// renamed, or have its type changed in a patch or minor release.
// Breaking changes require a major version bump. See CONTRACTS.md.
package scenario

// Scenario is generated by AI and consumed by agents. FROZEN at v1.0.
